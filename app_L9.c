...
void sl_bt_on_event(sl_bt_msg_t *evt)
{
  ...
  switch (SL_BT_MSG_ID(evt->header)) {
    ...
    case sl_bt_evt_connection_opened_id:
      uint8_t connection;
      sl_bt_sm_increase_security(advertising_set_handle);
    ...
    case sl_bt_evt_connection_parameters_id:
              app_log("conn = %d\n\r interval = %d\n\r latency = %d\n\r timeout = %d\n\r sec_mode = %d\n\r",evt->data.evt_connection_parameters.connection,
    ...
    case sl_bt_evt_gatt_server_attribute_value_id:
      if (gattdb_LED_IO == evt->data.evt_gatt_server_characteristic_status.characteristic) {sl_bt_gatt_server_read_attribute_value(gattdb_LED_IO,
                                                         0,
                                                         sizeof(recv_val),
                                                         &recv_len,
                                                         &recv_val);
